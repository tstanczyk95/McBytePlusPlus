...
# Adjusted (lines 300-301) by Tomasz Stanczyk https://github.com/tstanczyk95/McBytePlusPlus
...
class PerceiverResampler(nn.Module):
    ...
    def forward_2d(self, x):
        ...
        latents_2d = self.latents_2d.unsqueeze(0).expand(B, -1, -1).contiguous().view(-1, 1, C)

### Originally developed by Kaiyang Zhou et al. https://github.com/kaiyangzhou/deep-person-reid
### Adjusted (lines 88-89) by Tomasz Stanczyk https://github.com/tstanczyk95/McBytePlusPlus
